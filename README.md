...
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------ | ----------------------------------------------------------- |
| **01 – ReelTime**     | A cinematic movie discovery experience built around an interactive timeline using the TMDB API.                                                   | https://reeltime-app-amber.vercel.app/           | https://reeltime-app-amber.vercel.app/                      |
